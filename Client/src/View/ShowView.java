...
public class ShowView {
	...
	private void initialize() {
		...
		frame.setTitle(UserView.s.getName());
		...
		btnSelectShow.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				reqObj = obj3(UserView.s.getName(),Login.nameUser);
		...
		btnViewDetails.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		        ...
		        String mytext = UserView.s.getDescription();
		        ...
		        if(r!=null) {
		        	...
		        	desc_text1.setText("Rating:"+UserView.s.getRating());
		        	text.add(desc_text1);
		        }
		...
		btnRating.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JSONObject reqObj= new JSONObject();
				reqObj = obj1(UserView.s.getId(),rating);
				 String reqString= reqObj.toString();
		...
		btnAddComment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JSONObject reqObj= new JSONObject();
				System.out.println(Login.nameUser);
				reqObj = obj(com,Login.nameUser,UserView.s.getName());
				 String reqString= reqObj.toString();
		...
		btnViewComments.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String response=  Utility.excutePost(APIUrl, UserView.s.getName());
				Gson gson = new Gson();
